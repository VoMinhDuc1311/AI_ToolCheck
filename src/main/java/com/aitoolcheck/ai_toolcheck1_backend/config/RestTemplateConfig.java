 ...
 * This prevents the application from hanging indefinitely when the target server is unresponsive.
 */
@Configuration
public class RestTemplateConfig {
     ...
     * Wraps with BufferingClientHttpRequestFactory to allow response body to be read multiple times.
     *
