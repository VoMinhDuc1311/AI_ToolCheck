...
public class TestRunController {
    ...
    @Operation(
            ...
            description = "Create a test run and generate test run items from selected active test cases.",
    ...
    @Operation(
            summary = "List test runs by project",
            description = "List test runs for a source project ordered by newest first.",
            operationId = "listTestRunsByProject"
    )
    ...
    @Operation(
            ...
            description = "Get test run detail including generated test run items.",
    ...
    @Operation(
            summary = "Prepare test run requests",
            description = "Build prepared HTTP request objects for each test run item without executing them.",
            operationId = "prepareTestRun"
    )
