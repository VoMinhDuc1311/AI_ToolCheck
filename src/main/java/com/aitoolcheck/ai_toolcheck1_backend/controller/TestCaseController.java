...
public class TestCaseController {
    ...
    @Operation(
            ...
            description = "Create a complete test case with metadata, input and assertions.",
    ...
    @Operation(
            ...
            description = "List non-deleted test cases for a source project.",
            operationId = "listTestCasesByProject"
    )
    ...
    @Operation(
            ...
            description = "Get complete test case detail including input and assertions.",
    ...
    @Operation(
            ...
            description = "Update test case metadata, input and assertions.",
