 ...
 * {@code @JsonIgnoreProperties(ignoreUnknown = true)} bảo vệ khỏi trường hợp AI sinh dư field.
 * Getter {@code getAssertions()} null-safe để tránh NPE khi AI không sinh assertions.
 */
@Data
@NoArgsConstructor
...
public class AiTestCaseDto {
    ...
    /**
     * Null-safe getter: trả về empty list thay vì null nếu AI không sinh assertions.
     */
